...
import 'package:flutter_clean_achitecture_tdd_weather_app/presentation/bloc/weather_bloc.dart';
import 'package:flutter_clean_achitecture_tdd_weather_app/presentation/bloc/weather_event.dart';
import 'package:flutter_clean_achitecture_tdd_weather_app/presentation/bloc/weather_state.dart';
...
void main() {
  ...
  setUp(() {
    ...
    weatherBloc =
        WeatherBloc(mockGetCurrentWeatherUseCase as GetCurrentWeatherUseCase);
  });
